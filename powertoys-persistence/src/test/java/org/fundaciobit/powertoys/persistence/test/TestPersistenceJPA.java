package org.fundaciobit.powertoys.persistence.test;
...
public class TestPersistenceJPA {
    ...
    public static EntityManager initDB() {
        ...
        prop.put("javax.persistence.jdbc.url", "jdbc:postgresql://localhost:5432/powertoys");
        prop.put("javax.persistence.jdbc.user", "powertoys");
        prop.put("javax.persistence.jdbc.password", "powertoys");

        prop.put("hibernate.connection.driver_class", "org.postgresql.Driver");
        prop.put("hibernate.connection.url", "jdbc:postgresql://localhost:5432/powertoys");
        prop.put("hibernate.connection.username", "powertoys");
        prop.put("hibernate.connection.password", "powertoys");
        ...
        emf = Persistence.createEntityManagerFactory("powertoysPULocal", prop);
