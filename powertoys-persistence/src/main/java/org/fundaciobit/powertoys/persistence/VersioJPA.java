...
@Table(name = "pwt_versio" , indexes = { 
        @Index(name="pwt_versio_pk_i", columnList = "versioid"),
        @Index(name="pwt_versio_entornapli_fk_i", columnList = "entornaplicacioid")})
@SequenceGenerator(name="VERSIO_SEQ", sequenceName="pwt_versio_seq", allocationSize=1, initialValue=1000)
...
// IMP Field:entornaplicacioid | Table: pwt_entornaplicacio | Type: 1  
    ...
    @JoinColumn(name = "entornaplicacioid", referencedColumnName ="entornaplicacioid", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="pwt_versio_entornapli_fk"))
