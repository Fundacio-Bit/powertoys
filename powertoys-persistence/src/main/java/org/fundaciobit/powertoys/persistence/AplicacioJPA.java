...
@Table(name = "pwt_aplicacio" , indexes = { 
        @Index(name="pwt_aplicacio_pk_i", columnList = "aplicacioid")})
@SequenceGenerator(name="APLICACIO_SEQ", sequenceName="pwt_aplicacio_seq", allocationSize=1, initialValue=1000)
