...
@Table(name = "pwt_traducciomap" , indexes = { 
        @Index(name="pwt_traducciomap_pk_i", columnList = "traducciomapid"),
        @Index(name="pwt_traducciomap_idiomaid_fk_i", columnList = "idiomaid")})
