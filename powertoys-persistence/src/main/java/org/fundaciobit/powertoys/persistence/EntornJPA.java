...
@Table(name = "pwt_entorn" , indexes = { 
        @Index(name="pwt_entorn_pk_i", columnList = "entornid")})
@SequenceGenerator(name="ENTORN_SEQ", sequenceName="pwt_entorn_seq", allocationSize=1, initialValue=1000)
...
public class EntornJPA implements Entorn {
  ...
  public EntornJPA(Entorn __bean) {
    ...
    @Override
    public int hashCode() {
        return (String.valueOf(this.getEntornID())).hashCode();
    }

// EXP  Field:entornid | Table: pwt_entornaplicacio | Type: 0  
