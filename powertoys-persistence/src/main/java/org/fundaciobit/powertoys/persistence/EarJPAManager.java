...
public class EarJPAManager
    ...
    public Ear create( long _fitxerID_, java.sql.Timestamp _data_, java.lang.String _nom_, java.lang.String _jbossVersion_) throws I18NException {
        EarJPA __bean =  new EarJPA(_fitxerID_,_data_,_nom_,_jbossVersion_);
