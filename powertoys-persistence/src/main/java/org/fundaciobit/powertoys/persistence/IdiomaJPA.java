...
@Table(name = "pwt_idioma" , indexes = { 
        @Index(name="pwt_idioma_pk_i", columnList = "idiomaid")})
@SequenceGenerator(name="IDIOMA_SEQ", sequenceName="pwt_idioma_seq", allocationSize=1, initialValue=1000)
