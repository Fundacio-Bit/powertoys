...
public class EntornAplicacioBeanValidator 
  ...
  // EJB's
  protected final org.fundaciobit.powertoys.model.dao.IAplicacioManager __aplicacioManager;

  protected final org.fundaciobit.powertoys.model.dao.IEntornManager __entornManager;

  protected final org.fundaciobit.powertoys.model.dao.IEntornAplicacioManager __entornAplicacioManager;


  public final EntornAplicacioValidator<EntornAplicacioJPA> _validator;


  public EntornAplicacioBeanValidator(org.fundaciobit.powertoys.model.dao.IAplicacioManager __aplicacioManager,
     org.fundaciobit.powertoys.model.dao.IEntornManager __entornManager,
     org.fundaciobit.powertoys.model.dao.IEntornAplicacioManager __entornAplicacioManager) { 
  ...
  public EntornAplicacioBeanValidator(EntornAplicacioValidator<EntornAplicacioJPA> _validator,
     org.fundaciobit.powertoys.model.dao.IAplicacioManager __aplicacioManager,
     org.fundaciobit.powertoys.model.dao.IEntornManager __entornManager,
     org.fundaciobit.powertoys.model.dao.IEntornAplicacioManager __entornAplicacioManager) {
    this.__aplicacioManager = __aplicacioManager;
    this.__entornManager = __entornManager;
