...
@Table(name = "pwt_traduccio" , indexes = { 
        @Index(name="pwt_traduccio_pk_i", columnList = "traduccioid")})
@SequenceGenerator(name="TRADUCCIO_SEQ", sequenceName="pwt_traduccio_seq", allocationSize=1, initialValue=1000)
...
public class TraduccioJPA implements Traduccio {
  ...
  @JoinTable(name="pwt_traducciomap",joinColumns={@JoinColumn(name="traducciomapid")}, foreignKey=@ForeignKey(name="pwt_traducmap_traduccio_fk"))
  @javax.persistence.MapKeyColumn(name="idiomaid")
  private Map<String, org.fundaciobit.powertoys.persistence.TraduccioMapJPA> traduccions =  new HashMap<String, org.fundaciobit.powertoys.persistence.TraduccioMapJPA>();

  public Map<String, org.fundaciobit.powertoys.persistence.TraduccioMapJPA> getTraduccions() {
    return this.traduccions;
  }

  public void setTraduccions(Map<String, org.fundaciobit.powertoys.persistence.TraduccioMapJPA> _traduccions_) {
  ...
  public org.fundaciobit.powertoys.persistence.TraduccioMapJPA getTraduccio(String idioma) {
    return (org.fundaciobit.powertoys.persistence.TraduccioMapJPA) traduccions.get(idioma);
  }
  
  public void addTraduccio(String idioma, org.fundaciobit.powertoys.persistence.TraduccioMapJPA traduccio) {
    if (traduccio == null) {
