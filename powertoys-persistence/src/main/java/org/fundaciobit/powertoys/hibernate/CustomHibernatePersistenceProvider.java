package org.fundaciobit.powertoys.hibernate;
		...
		if(fitxerProperties != null) {
			fitxerProperties.forEach((k,v) -> {
               String kStr = k.toString();
	        	if (kStr.startsWith("org.fundaciobit.powertoys.hibernate")) {
	        		projecteProperties.put(kStr.replace("org.fundaciobit.powertoys.",""), v.toString());
