...
/* L'ús d'aquest camp (OneToMany) llança una exception:
 ...
 // TODO Solució dins el mètode testOneByOneDirect de la classe TestJPA 
  ...
  public EarQueryPath EARS() {
    return new EarQueryPath(new QueryPath() {
      public String getQueryPath() {
          return FitxerQueryPath.this.getQueryPath() + "ears" + ".";
      }
    });
  }
*/
...
/* L'ús d'aquest camp (OneToMany) llança una exception:
 ...
 // TODO Solució dins el mètode testOneByOneDirect de la classe TestJPA 
  ...
  public EarSimpleQueryPath EARSIMPLES() {
    return new EarSimpleQueryPath(new QueryPath() {
      public String getQueryPath() {
          return FitxerQueryPath.this.getQueryPath() + "earSimples" + ".";
      }
    });
  }
*/
