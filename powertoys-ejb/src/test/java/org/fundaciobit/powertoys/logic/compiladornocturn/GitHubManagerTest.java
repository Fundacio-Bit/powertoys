...
public class GitHubManagerTest {
                ...
                return Arrays.asList(new Object[][] {
                                {
                                                ...
                                                "Adjunt un projecte per generar el client.",
                                                "Moure informació de EARs a menu PUBLIC",
                                ...
                                },
                                {
                                                ...
                                                "Crear la base de QueEsticFent emprant GenApp",
                                                "queesticfent-2.0.0_20240416"
                                }
                });
        }
        ...
        public void setUp() throws IOException {
                gitHubManager = gitHubManagers.get(owner);
        }
        ...
        public void testGetProjects() throws IOException {
                ...
                assertEquals("El nom del primer projecte de " + owner + "/" + repo + "hauria de ser \""
                                + this.mockFirstGhProjectName + "\" i no \"" + firstGhProjectName + "\"",
                                this.mockFirstGhProjectName,
                                firstGhProjectName);
        }
        ...
        public void testGetProject() throws IOException {
                ...
                assertNotNull("No s'ha trobat cap projecte " + projectId + " per l'entitat " + owner + " i repositori "
                                + repo, result);
        ...
        public void testGetIssues() throws IOException {
                ...
                assertEquals("El nom del primer Issue de " + owner + "/" + repo + "hauria de ser \""
                                + this.mockFirstGhIssueTitle + "\" i no \"" + firstGhIssueTitle + "\"",
                                this.mockFirstGhIssueTitle,
                                firstGhIssueTitle);
        }
        ...
        public void testGetTags() throws IOException {
                ...
                assertEquals("El nom del primer Tag de " + owner + "/" + repo + "hauria de ser \""
                                + this.mockFirstGhTagName + "\" i no \"" + firstGhTagName + "\"",
                                this.mockFirstGhTagName,
                                firstGhTagName);
        }
        ...
        public void testGetLatestTag() throws IOException {
                ...
                assertNotEquals(
                                "El nom del darrer tag del repositori " + owner + "/" + repo
                                                + " no pot ser un string buit. Commit del tag trobat com a darrer: "
                                                + result.getCommit(),
                                "", result.getName().trim());
