...
import org.fundaciobit.powertoys.ejb.VersioEJB;
import org.fundaciobit.powertoys.model.bean.VersioBean;
...
public class VersioLogicaEJB extends VersioEJB implements VersioLogicaService {
    ...
    public List<Versio> getVersionsMajors() throws I18NException {
        ...
        // this.versioEjb.getEntityManager().createNativeQuery("SELECT DISTINCT
        // entornaplicacioid, data, versio FROM ver_versio WHERE data IN (SELECT
        // MAX(data) FROM ver_versio GROUP BY entornaplicacioid)");
