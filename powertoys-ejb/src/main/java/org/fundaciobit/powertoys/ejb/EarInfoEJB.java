...
import org.fundaciobit.powertoys.persistence.EarInfoJPAManager;

import org.fundaciobit.powertoys.commons.utils.Constants;

@Stateless
public class EarInfoEJB extends EarInfoJPAManager implements EarInfoService {

    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void delete(EarInfo instance) {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public EarInfo update(EarInfo instance) throws I18NException {
         return super.update(instance);
    }

    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(EarInfo instance,  FitxerService fitxerEjb)
