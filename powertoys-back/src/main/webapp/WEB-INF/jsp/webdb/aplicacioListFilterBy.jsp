...
<un:useConstants var="AplicacioFields" className="org.fundaciobit.powertoys.model.fields.AplicacioFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AplicacioFields.APLICACIOID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="aplicacio.aplicacioID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AplicacioFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="aplicacio.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AplicacioFields.CONTEXTPATH)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="aplicacio.contextPath" var="contextPath" />
              <fmt:message key="genapp.form.searchby" var="cercapercontextPath" >                
                 <fmt:param value="${contextPath}"/>
              </fmt:message>
              <span class="add-on"><c:out value="${contextPath}" />:</span>
              <form:input cssClass="search-query input-medium" placeholder="${cercapercontextPath}" path="contextPath" />
            </div>
