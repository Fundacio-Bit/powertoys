	    ...
	    --%>
            ...
            <sec:authorize access="hasRole('ROLE_USER')">
                <li class="nav-item"><a
                    ...
                    href="<c:url value="/canviarPipella/user"/>"><fmt:message key="public.menu.usuari"/></a>
                </li>
            </sec:authorize>
            ...
            <sec:authorize access="hasRole('ROLE_ADMIN')">
                <li class="nav-item"><a
                    ...
                    href="<c:url value="/canviarPipella/admin"/>"><fmt:message key="public.menu.administrador"/></a>
                </li>
            </sec:authorize>
