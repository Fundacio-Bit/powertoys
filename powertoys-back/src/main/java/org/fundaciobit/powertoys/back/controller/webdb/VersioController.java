...
import org.fundaciobit.powertoys.back.validator.webdb.VersioWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="versio.versio.plural", order=100, group="WEBDB")
@Controller
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Versio
   */
  @RequestMapping(value = "/cancel")
  public String cancelVersio(HttpServletRequest request,HttpServletResponse response) {
