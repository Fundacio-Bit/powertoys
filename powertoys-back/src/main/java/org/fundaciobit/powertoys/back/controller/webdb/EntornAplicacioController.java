...
import org.fundaciobit.powertoys.back.validator.webdb.EntornAplicacioWebValidator;
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de EntornAplicacio
   */
  @RequestMapping(value = "/cancel")
  public String cancelEntornAplicacio(HttpServletRequest request,HttpServletResponse response) {
