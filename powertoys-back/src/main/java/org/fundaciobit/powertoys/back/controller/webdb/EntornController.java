...
import org.fundaciobit.powertoys.back.validator.webdb.EntornWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="entorn.entorn.plural", order=40, group="WEBDB")
@Controller
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Entorn
   */
  @RequestMapping(value = "/cancel")
  public String cancelEntorn(HttpServletRequest request,HttpServletResponse response) {
