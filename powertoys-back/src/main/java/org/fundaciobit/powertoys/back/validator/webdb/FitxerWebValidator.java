...
import org.fundaciobit.powertoys.persistence.validator.FitxerValidator;

import org.fundaciobit.powertoys.back.form.webdb.FitxerForm;
...
public class FitxerWebValidator extends AbstractWebValidator<FitxerForm, Fitxer>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = org.fundaciobit.powertoys.ejb.FitxerService.JNDI_NAME)
