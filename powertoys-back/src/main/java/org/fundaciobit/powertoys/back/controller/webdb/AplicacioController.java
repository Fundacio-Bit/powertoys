...
import org.fundaciobit.powertoys.back.validator.webdb.AplicacioWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="aplicacio.aplicacio.plural", order=0, group="WEBDB")
@Controller
...
public class AplicacioController
  ...
  @EJB(mappedName = org.fundaciobit.powertoys.ejb.AplicacioService.JNDI_NAME)
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Aplicacio
   */
  @RequestMapping(value = "/cancel")
  public String cancelAplicacio(HttpServletRequest request,HttpServletResponse response) {
