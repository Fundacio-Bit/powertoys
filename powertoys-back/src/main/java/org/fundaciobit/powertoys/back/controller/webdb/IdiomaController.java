...
import org.fundaciobit.powertoys.back.form.webdb.IdiomaForm;

import org.fundaciobit.powertoys.back.validator.webdb.IdiomaWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="idioma.idioma.plural", order=80, group=Constants.MENU_BACK_WEBDB_ACCESS)
@Controller
