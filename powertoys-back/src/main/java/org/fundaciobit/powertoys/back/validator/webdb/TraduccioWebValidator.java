...
import org.fundaciobit.powertoys.persistence.validator.TraduccioValidator;
...
public class TraduccioWebValidator extends AbstractWebValidator<TraduccioForm, Traduccio>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = org.fundaciobit.powertoys.ejb.TraduccioService.JNDI_NAME)
