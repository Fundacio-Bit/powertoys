...
import org.fundaciobit.powertoys.ejb.TraduccioService;
import org.fundaciobit.genapp.common.i18n.I18NException;
import org.fundaciobit.powertoys.model.fields.TraduccioFields;
...
public class TraduccioRefList extends RefListBase
  ...
  public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
    List<org.fundaciobit.powertoys.model.entity.Traduccio> traduccions = traduccioEjb.select(where);
    ...
    for (org.fundaciobit.powertoys.model.entity.Traduccio traduccio : traduccions) {
      org.fundaciobit.powertoys.persistence.TraduccioJPA traduccioJPA = (org.fundaciobit.powertoys.persistence.TraduccioJPA) traduccio;
      String key = String.valueOf(traduccioJPA.getTraduccioID());
      org.fundaciobit.powertoys.persistence.TraduccioMapJPA _tm = traduccioJPA.getTraduccio(_lang);
      String value;
      if (_tm == null) {
