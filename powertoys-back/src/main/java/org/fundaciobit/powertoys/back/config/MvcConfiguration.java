package org.fundaciobit.powertoys.back.config;
 ...
 */
@Configuration
@ComponentScan(basePackages = {"org.fundaciobit.powertoys"})
@EnableWebMvc
public class MvcConfiguration extends WebMvcConfigurerAdapter {
	...
	public BeanPostProcessor beanPostProcessor() {
	    return new org.fundaciobit.powertoys.back.security.DefaultRolesPrefixPostProcessor();
	}
	...
	public MessageSource messageSource() {
		...
		messageSource.addBasenames("/WEB-INF/classes/missatges", "/WEB-INF/classes/logicmissatges",
				"/WEB-INF/classes/powertoys_genapp", "/WEB-INF/classes/genapp");
