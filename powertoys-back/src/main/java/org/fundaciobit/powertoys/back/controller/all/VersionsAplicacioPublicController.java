...
import org.fundaciobit.powertoys.back.controller.admin.EntornAdminController;
import org.fundaciobit.powertoys.back.controller.webdb.AplicacioController;
...
import org.fundaciobit.powertoys.model.fields.AplicacioFields;
import org.fundaciobit.powertoys.model.fields.EntornAplicacioFields;
import org.fundaciobit.powertoys.model.fields.EntornFields;
import org.fundaciobit.powertoys.model.fields.VersioFields;
import org.fundaciobit.powertoys.model.fields.VersioQueryPath;
 ...
 *
 */
@MenuOption(labelCode = "versionsaplicacions.aplicacio.plural", order = 3, group = "PUBLIC", addSeparatorBefore = true)
@Controller
@RequestMapping(value = "/public/versioperaplicacio")
...
public class VersionsAplicacioPublicController extends AplicacioController {
    ...
    @EJB(mappedName = org.fundaciobit.powertoys.ejb.EntornService.JNDI_NAME)
    protected org.fundaciobit.powertoys.ejb.EntornService entornEjb;
