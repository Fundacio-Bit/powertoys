 ...
 * @author GenApp
 */
@MenuOption(labelCode = "earSimple.earSimple.plural", order = 40, group = Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/earSimple")
@SessionAttributes(types = { EarSimpleForm.class, EarSimpleFilterForm.class })
@Tile(
        name = "earSimpleFormWebDB",
        contentJsp = "/WEB-INF/jsp/webdb/earSimpleForm.jsp",
        extendsTile = Tab.MENU_WEBDB,
        type = TileType.WEBDB_FORM,
        attributes = { @TileAttribute(name = "titol", value = "earSimple.earSimple") })
@Tile(
        name = "earSimpleListWebDB",
        contentJsp = "/WEB-INF/jsp/webdb/earSimpleList.jsp",
        extendsTile = Tab.MENU_WEBDB,
        type = TileType.WEBDB_LIST,
        attributes = { @TileAttribute(name = "titol", value = "earSimple.earSimple") })
public class EarSimpleController extends
        org.fundaciobit.powertoys.back.controller.PowerToysFilesBaseController<EarSimple, java.lang.Long, EarSimpleForm>
    ...
    public ModelAndView llistatPaginat(HttpServletRequest request, HttpServletResponse response, @PathVariable
    Integer pagina) throws I18NException {
        if (!isActiveList()) {
     ...
     * @throws I18NException
     */
    protected List<EarSimple> llistat(ModelAndView mav, HttpServletRequest request, EarSimpleFilterForm filterForm)
            throws I18NException {
        ...
        List<EarSimple> earSimple = processarLlistat(earSimpleEjb, filterForm, pagina, getAdditionalCondition(request),
                mav);
        ...
        fillReferencesForList(filterForm, request, mav, earSimple,
    ...
    public Map<Field<?>, GroupByItem> fillReferencesForList(EarSimpleFilterForm filterForm, HttpServletRequest request,
            ModelAndView mav, List<EarSimple> list, List<GroupByItem> groupItems) throws I18NException {
    ...
    String dataExporterID, HttpServletRequest request, HttpServletResponse response, EarSimpleFilterForm filterForm)
    ...
    public ModelAndView crearEarSimpleGet(HttpServletRequest request, HttpServletResponse response)
            throws I18NException {
    ...
    public void fillReferencesForForm(EarSimpleForm earSimpleForm, HttpServletRequest request, ModelAndView mav)
            throws I18NException {
    ...
    public ModelAndView veureEarSimpleGet(@PathVariable("earSimpleID")
    java.lang.Long earSimpleID, HttpServletRequest request, HttpServletResponse response) throws I18NException {
        return editAndViewEarSimpleGet(earSimpleID, request, response, true);
    }

    protected ModelAndView editAndViewEarSimpleGet(@PathVariable("earSimpleID")
    java.lang.Long earSimpleID, HttpServletRequest request, HttpServletResponse response, boolean __isView)
            throws I18NException {
    ...
    public ModelAndView editarEarSimpleGet(@PathVariable("earSimpleID")
    java.lang.Long earSimpleID, HttpServletRequest request, HttpServletResponse response) throws I18NException {
        return editAndViewEarSimpleGet(earSimpleID, request, response, false);
    }
    ...
    public String editarEarSimplePost(@ModelAttribute
    EarSimpleForm earSimpleForm, BindingResult result, SessionStatus status, HttpServletRequest request,
        ...
        try {
            ...
            String msg = createMessageError(request, "error.modification", earSimple.getEarSimpleID(), __e);
            log.error(msg, __e);
    ...
    EarSimpleFilterForm filterForm) throws Exception {
    ...
    public String[] getArgumentsMissatge(Object __earSimpleID, Throwable e) {
        ...
        if (earSimpleID == null) {
            ...
            return new String[] { I18NUtils.tradueix(getEntityNameCode()), getPrimaryKeyColumnsTranslated(),
                    String.valueOf(earSimpleID), exceptionMsg };
        }
    }
    ...
    public String cancelEarSimple(@PathVariable("earSimpleID")
    java.lang.Long earSimpleID, HttpServletRequest request, HttpServletResponse response) {
    ...
    // FILE
    @Override
    public void setFilesFormToEntity(FilesFormManager<Fitxer> afm, EarSimple earSimple, EarSimpleForm form)
            throws I18NException {
    ...
    public void postValidate(HttpServletRequest request, EarSimpleForm earSimpleForm, BindingResult result)
            throws I18NException {
    }

    public void preList(HttpServletRequest request, ModelAndView mav, EarSimpleFilterForm filterForm)
            throws I18NException {
    }

    public void postList(HttpServletRequest request, ModelAndView mav, EarSimpleFilterForm filterForm,
            List<EarSimple> list) throws I18NException {
    }
