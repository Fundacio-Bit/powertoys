...
import org.fundaciobit.powertoys.hibernate.HibernateFileUtil;
import org.fundaciobit.powertoys.logic.utils.I18NLogicUtils;
import org.fundaciobit.powertoys.logic.utils.LogicUtils;
    ...
    public void init(ServletConfig config) throws ServletException {
            ...
            public void run() {
                try {
                    MenuOptionManager.setDiscoverMenuOptionAnnotations(
                            new DiscoverMenuOptionAnnotations(Constants.POWERTOYS_PROPERTY_BASE + "back.controller"));
                } catch (Throwable th) {
        ...
        try {
            ...
            if (fd == null) {
                throw new Exception("No s'ha definit la propietat de la ubicació dels fitxers ("
                        + "org.fundaciobit.powertoys.filesdirectory)");
            }
            if (!fd.exists()) {
        ...
        try {
            ...
            String[] basenames = { "missatges", // /WEB-INF/classes/
                    "logicmissatges", "genapp", "powertoys_genapp" };
        ...
        try {
            log.info("powertoys Version: " + ver);
        } catch (Throwable e) {
            log.info("powertoys Version: " + ver);
        }
