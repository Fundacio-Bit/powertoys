...
public class FileDownloadController {
  ...
  public void arxiu(@PathVariable("arxiuId") String encryptedArxiuId,
    ...
    if (arxiuId == 0) {
      ...
      String msg = I18NUtils.tradueix("error.filedownload.nodesencriptat");
      response.setHeader("Msgpowertoys", msg);
  ...
  public static void fullDownload(long arxiuId, String filename, String contentType,
    ...
    try {
      ...
      if (!file.exists()) {
        String msg = I18NUtils.tradueix("error.filedownload.notrobat", Long.toString(arxiuId));
        response.setHeader("Msgpowertoys", msg);
        response.sendError(HttpServletResponse.SC_NOT_FOUND);
        return;
      }
