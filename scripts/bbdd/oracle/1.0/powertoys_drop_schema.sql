    ...
    drop table pwt_earsimple cascade constraints;

    drop table pwt_entorn cascade constraints;

    drop table pwt_entornaplicacio cascade constraints;

    drop table pwt_fitxer cascade constraints;
    ...
    drop sequence pwt_earinfo_seq;

    drop sequence pwt_earsimple_seq;

    drop sequence pwt_entorn_seq;
